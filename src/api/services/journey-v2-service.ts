...
export class JourneyV2ApiService {
 ...
 async search(input:unknown,requestId:string=randomUUID()):Promise<JourneyV2Response>{
  ...
  try{
   ...
   log('journey_v2_search_completed',{directCandidates:d.directCandidates,directWholeLegChecks:d.directWholeLegChecks,directWholeLegUsable:d.directWholeLegUsable,sameTrainRecoveryCandidates:d.sameTrainRecoveryCandidates,sameTrainStationsEligible:d.sameTrainStationsEligible,sameTrainStationsConsidered:d.sameTrainStationsConsidered,sameTrainStationsRemaining:d.sameTrainStationsRemaining,sameTrainFullRecoveries:d.sameTrainFullRecoveries,directLaneBudgetUsed:d.directLaneBudgetUsed,indirectLaneStarted:d.indirectLaneStarted,indirectLaneBudgetUsed:d.indirectLaneBudgetUsed,...(this.options.diagnostics?{directExploration:d.directExploration}:{}),...metrics,unsupportedEvidenceCacheHits:d.unsupportedEvidenceCacheHits,providerUnsupportedResponses:d.providerUnsupportedResponses,availabilityCallsMeaning:'BUDGETED_CHECKS',plannerCandidates:d.plannerCandidatesReceived,resultCount:results.length,availabilityCalls:d.availabilityRequestsUsed,budgetLimit:d.availabilityBudgetLimit,durationMs:Math.round(performance.now()-start)});
